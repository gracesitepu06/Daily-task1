...
// 1. buat function getEyeColor
function getEyeColor(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    // 4. buat filter untuk user eyeColor blue
...
console.log(`Jumlah user yang eyeColor blue ada ${getEyeColor(users).length}`);
