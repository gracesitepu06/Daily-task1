...
function getFriend(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    for (const friends of data[i].friends) {
      // 5. buat filter untuk frien yang bernama Imam
      if (friends.name === "Imam") {
...
console.log(
  `Jumlah user yang memiliki friends Imam ada ${getFriend(users).length}`
);
