...
function getRegistered(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    // 4. buat filter untuk user yang registered antara 2014 - 2018
...
console.log(getRegistered(users));
console.log(
  `Jumlah user yang registered pada antara 2014 - 2018 ada ${
    getRegistered(users).length
  }`
);
