...
// Fungsi untuk menentukan apakah seorang pengguna memenuhi kriteria
function isUserEligible(user) {
  return user.age < 30 && isRegisteredAfter2018(user.registered);
}

// Hitung jumlah pengguna yang memenuhi kriteria
const eligibleUsers = users.filter(isUserEligible);
const jumlahEligibleUsers = eligibleUsers.length;

console.log(
  `Jumlah pengguna yang berumur di bawah 30 dan terdaftar setelah tahun 2018 adalah: ${jumlahEligibleUsers}`
);
