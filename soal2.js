...
// 1. buat function getFemale
function getFemale(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    // 4. buat filter untuk user bergender female
...
console.log(`Jumlah user bergender female ada ${getFemale(users).length}`);
